            ...
            if customer.subscriptions && customer.subscriptions.first
              ...
              if upgrading?
                if respond_to? :coupon
                  Rails.logger.info ">>>> [1.0] Inside Concern::Subscription | respond_to? :coupon : #{respond_to? :coupon} | params : #{params}"
                  if coupon.present?
        ...
        # when customer DOES NOT exist in stripe ..
          ...
          if self.plan.present?
            ...
            begin
              ...
              if respond_to? :coupon
                Rails.logger.info ">>>> [2.0] Inside Concern::Subscription | respond_to? :coupon : #{respond_to? :coupon}  | params : #{params}"
                if coupon.present?
